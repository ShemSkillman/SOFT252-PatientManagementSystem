 ...
 * @author Shem
 */
public class ControlInspectPatientHistoryAction implements IObserver   {
    
    private ModelMain modelMain;
    private ViewDoctorMainMenu viewDoctorMainMenu;
    
    public ControlInspectPatientHistoryAction(ViewDoctorMainMenu viewDoctorMainMenu, ModelMain modelMain) {
        
        this.modelMain = modelMain;
        this.viewDoctorMainMenu = viewDoctorMainMenu;
        
        viewDoctorMainMenu.onInspectPatientHistory.addObserver(this);
    }
    
    @Override
    public void update() {        
        modelMain.doctorInspectPatientHistory();
    }
}
