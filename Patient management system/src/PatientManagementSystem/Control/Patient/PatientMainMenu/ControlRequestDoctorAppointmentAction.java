...
public class ControlRequestDoctorAppointmentAction implements IObserver  {
    ...
    public ControlRequestDoctorAppointmentAction(ViewPatientMainMenu viewPatientMainMenu, ModelMain modelMain) {
        
        this.modelMain = modelMain;
        viewPatientMainMenu.onRequestAppointment.addObserver(this);
    }
    
    @Override
    public void update() {
        modelMain.patientRequestDoctorAppointment();
    }
}
