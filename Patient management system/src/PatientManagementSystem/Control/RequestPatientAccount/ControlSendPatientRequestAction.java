 ...
 */
package PatientManagementSystem.Control.RequestPatientAccount;
...
public class ControlSendPatientRequestAction implements IObserver {
    ...
    public void update() {
        ...
        modelMain.getModelPatientAccountRequestSystem().RequestAccount(patient, password);
        
        viewRequestPatientAccount.showMessage("Request sent", "Request for patient account has been sent and will be reviewed shortly.");
